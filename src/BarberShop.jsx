...
export default function BarberShop() {
  ...
  const [drawerOpen, setDrawerOpen] = React.useState(false); // Estado para el Drawer
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="fixed" sx={{ backgroundColor: "0aa6bc" }}>
        <Toolbar>
          <IconButton
            size="large"
            edge="start"
      ...
      <Drawer anchor="left" open={drawerOpen} onClose={toggleDrawer(false)}>
        {renderDrawer()} {/* Renderiza el Drawer con los iconos */}
      </Drawer>
